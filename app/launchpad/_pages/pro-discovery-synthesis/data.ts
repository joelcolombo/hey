...
export const tenThings = [
  ...
  { lede: 'Evolution instead of a fresh start', body: '4 vote "keep and refine its energy", 3 vote "a clear evolution", 0 vote "fresh start". The story is "same mission, sharper tools" in a new operating environment.' },
