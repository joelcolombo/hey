  ...
  return (
    <main className="syn-page pb-32">
      ...
      <section className="max-w-4xl mx-auto px-6 py-24 border-t border-[var(--hairline)]">
        ...
        <p className="mt-8 font-light text-[2em] leading-[1.25] max-md:text-[1.5em] text-balance max-w-3xl">
          None of it is a verdict: the open tensions above are yours to weigh in on, and that is exactly what the moodboard session is for.
        </p>
      </section>
