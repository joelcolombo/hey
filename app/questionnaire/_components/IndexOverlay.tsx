              ...
              {section.questions.map((question) => {
                ...
                return (
                  ...
                  >
                    ...
                    {answered ? (
                      <span className="label text-[0.75rem] shrink-0" aria-label="answered">✓</span>
                    ) : skipped ? (
                      <span className="label text-[0.75rem] shrink-0 text-[var(--hover-color)]" aria-label="skipped">–</span>
                    ) : null}
                  </button>
                )
              })}
