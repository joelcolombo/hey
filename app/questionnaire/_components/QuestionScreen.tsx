      ...
      <div className="my-auto pt-20 pb-24">
        ...
        <div className="flex items-center gap-6">
          <button onClick={() => submit()} disabled={!draft}
            className="border border-[var(--foreground)] rounded-full px-8 py-3 text-[1.1em] hover:bg-[var(--foreground)] hover:text-[var(--background)] transition-[opacity,color,background-color,border-color] duration-300 ease-out disabled:opacity-30 disabled:pointer-events-none">
            Next →
          </button>
